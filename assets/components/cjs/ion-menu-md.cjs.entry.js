...
const Menu = class {
    ...
    async connectedCallback() {
        ...
        index.menuController._register(this);
    ...
    disconnectedCallback() {
        ...
        index.menuController._unregister(this);
        if (this.animation) {
    ...
    setOpen(shouldOpen, animated = true) {
        return index.menuController._setOpen(this, shouldOpen, animated);
    }
    ...
    async loadAnimation() {
        ...
        this.animation = await index.menuController._createAnimation(this.type, this);
    ...
    canStart(detail) {
        ...
        else if (index.menuController._getOpenSync()) {
            return false;
        }
    ...
    updateState() {
        ...
        if (!this.disabled) {
            index.menuController._setActiveMenu(this);
        }
