...
const Calculator = class {
    ...
    renderFutureValue(data) {
        return data && data.futureValue ? (core.h("ion-note", { slot: "end", style: { 'font-size': '15px' } }, this.currency(data.futureValue))) : (core.h("ion-skeleton-text", { animated: true, style: { height: '17px', width: '72px' } }));
    }
    renderMortgageItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.mortgage } }), core.h("ion-label", null, AccountLabel.mortgage), this.renderFutureValue(this.mortgageData))) : null;
    }
    renderTFSAItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.tfsa } }), core.h("ion-label", null, AccountLabel.tfsa), this.renderFutureValue(this.tfsaData))) : null;
    }
    renderRRSPItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.rrsp } }), core.h("ion-label", null, AccountLabel.rrsp), this.renderFutureValue(this.rrspData))) : null;
    }
    renderNonRegisteredItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.nonRegistered } }), core.h("ion-label", null, AccountLabel.nonRegistered), this.renderFutureValue(this.nonRegisteredData))) : null;
    }
...
const RRSPForm = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("ion-card", null, core.h("ion-card-header", null, core.h("ion-card-title", null, "RRSP Details")), core.h("ion-item", null, core.h("ion-checkbox", { slot: "start", checked: this.reinvestTaxReturn, onIonChange: this.handleChange.bind(this) }), core.h("ion-label", null, "Reinvest Tax Return"), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "Reinvest the tax return."))))));
    }
