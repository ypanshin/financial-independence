...
const ScheduleChartComponent = class {
    ...
    static get style() { return ":host{display:block;position:relative;padding-top:16px}.chart-spinner,:host{height:100%;width:100%}.chart-spinner{position:absolute;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;left:0;top:0}"; }
};
...
const ScheduleTableComponent = class {
    ...
    renderRow(index) {
        ...
        return (core.h("ion-row", null, core.h("ion-col", null, year), core.h("ion-col", null, this.mortgage[index] ? Utils.currency(this.mortgage[index]) : ''), core.h("ion-col", null, this.tfsa[index] ? Utils.currency(this.tfsa[index]) : ''), core.h("ion-col", null, this.rrsp[index] ? Utils.currency(this.rrsp[index]) : ''), core.h("ion-col", null, this.nonRegistered[index] ? Utils.currency(this.nonRegistered[index]) : '')));
    }
    getDataLength(type) {
        return this[type] ? this[type].length : 0;
    }
    static get style() { return "ion-row{border-bottom:1px solid rgba(0,0,0,.13)}"; }
};
...
const InvestmentGuide = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("div", { class: "content" }, this.renderWizard(this.mode), this.renderCalculator(this.mode))));
    }
    ...
    static get style() { return ".content{text-align:center}.content>*{margin:auto;--ion-color-danger:#f04141}"; }
};
