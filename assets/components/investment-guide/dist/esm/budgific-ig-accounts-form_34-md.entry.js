import { r as registerInstance, c as createEvent, h, H as Host, d as getContext, e as getElement, f as getIonMode$1, i as getAssetPath, j as getMode, k as readTask, w as writeTask, l as config } from './core-6682cc20.js';
...
const Calculator = class {
    ...
    renderMortgageItem(show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.mortgage } }), h("ion-label", null, AccountLabel.mortgage), this.renderFutureValue(this.mortgageFutureValue))) : null;
    }
    renderTFSAItem(show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.tfsa } }), h("ion-label", null, AccountLabel.tfsa), this.renderFutureValue(this.tfsaFutureValue))) : null;
    }
    renderRRSPItem(show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.rrsp } }), h("ion-label", null, AccountLabel.rrsp), this.renderFutureValue(this.rrspFutureValue))) : null;
    }
    renderNonRegisteredItem(show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.nonRegistered } }), h("ion-label", null, AccountLabel.nonRegistered), this.renderFutureValue(this.nonRegisteredFutureValue))) : null;
    }
...
const RRSPForm = class {
    ...
    render() {
        return (h(Host, null, h("ion-card", null, h("ion-card-header", null, h("ion-card-title", null, "RRSP Details")), h("ion-item", { class: "item-multiple-inputs" }, h("ion-checkbox", { slot: "start", checked: this.reinvestTaxReturn, onIonChange: this.handleChange.bind(this) }), h("ion-label", null, "Reinvest Tax Return"), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "The best approach is to reinvest the tax return that you receive when contributing to RRSP."))))));
    }
...
const Schedule = class {
    ...
    render() {
        return (h(Host, null, h("ion-segment", { value: Segment.graph, onIonChange: this.handleSegmentChange.bind(this) }, h("ion-segment-button", { value: Segment.graph }, h("ion-label", null, "Graph")), h("ion-segment-button", { value: Segment.table }, h("ion-label", null, "Table"))), h("budgific-ig-schedule-chart", { loading: this.loading, mortgage: this.mortgage ? this.mortgage.chartData : null, tfsa: this.tfsa ? this.tfsa.chartData : null, rrsp: this.rrsp ? this.rrsp.chartData : null, nonRegistered: this.nonRegistered ? this.nonRegistered.chartData : null, style: { display: this.segment === Segment.table ? 'none' : '' } }), this.renderTable(this.segment === Segment.table)));
    }
    renderTable(show) {
...
const ScheduleChartComponent = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "chart-spinner", style: { 'display': this.loading ? 'flex' : 'none' } }, h("ion-spinner", { name: "lines", color: "primary" })), h("canvas", { style: { 'visibility': this.showChart() }, ref: (charts) => this.charts = charts })));
    }
    showChart() {
...
const ScheduleTableComponent = class {
    ...
    render() {
        return (h(Host, null, h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("h3", null, "Year")), h("ion-col", null, h("h3", null, "Mortgage")), h("ion-col", null, h("h3", null, "TFSA")), h("ion-col", null, h("h3", null, "RRSP")), h("ion-col", null, h("h3", null, "Non Registered"))), this.renderRows())));
    }
    renderRows() {
    ...
    renderRow(index) {
        ...
        return (h("ion-row", null, h("ion-col", null, h("div", null, year)), h("ion-col", null, h("div", null, this.mortgage[index] ? Utils.currency(this.mortgage[index]) : '')), h("ion-col", null, h("div", null, this.tfsa[index] ? Utils.currency(this.tfsa[index]) : '')), h("ion-col", null, h("div", null, this.rrsp[index] ? Utils.currency(this.rrsp[index]) : '')), h("ion-col", null, h("div", null, this.nonRegistered[index] ? Utils.currency(this.nonRegistered[index]) : ''))));
    }
    getDataLength(type) {
...
const InvestmentGuide = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "content" }, this.renderWizard(this.mode), this.renderCalculator(this.mode), h("p", null, h("ion-text", { color: "medium", class: "copy" }, "\u00A9 Budgific ", new Date().getFullYear())))));
    }
...
const Card = class {
    ...
    render() {
        const mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({ [mode]: true }, createColorClasses$1(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    }
...
const CardHeader = class {
    ...
    render() {
        const mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), { 'card-header-translucent': this.translucent, [mode]: true }) }, h("slot", null)));
    }
...
const CardTitle = class {
    ...
    render() {
        const mode = getIonMode$1(this);
        return (h(Host, { role: "heading", "aria-level": "2", class: Object.assign({}, createColorClasses$1(this.color), { [mode]: true }) }, h("slot", null)));
    }
...
const Input = class {
    ...
    render() {
        ...
        return (h(Host, { "aria-disabled": this.disabled ? 'true' : null, class: Object.assign({}, createColorClasses$1(this.color), { [mode]: true, 'has-value': this.hasValue(), 'has-focus': this.hasFocus }) }, h("input", { class: "native-input", ref: input => this.nativeInput = input, "aria-labelledby": labelId, disabled: this.disabled, accept: this.accept, autoCapitalize: this.autocapitalize, autoComplete: this.autocomplete, autoCorrect: this.autocorrect, autoFocus: this.autofocus, inputMode: this.inputmode, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, multiple: this.multiple, name: this.name, pattern: this.pattern, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellCheck: this.spellcheck, step: this.step, size: this.size, type: this.type, value: value, onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeydown }), (this.clearInput && !this.readonly && !this.disabled) && h("button", { type: "button", class: "input-clear-icon", tabindex: "-1", onTouchStart: this.clearTextInput, onMouseDown: this.clearTextInput })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const Label = class {
    ...
    render() {
        const position = this.position;
        const mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), { [mode]: true, [`label-${position}`]: position !== undefined, [`label-no-animate`]: (this.noAnimate) }) }));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const Note = class {
    ...
    render() {
        const mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), { [mode]: true }) }, h("slot", null)));
    }
...
const Segment$1 = class {
    ...
    render() {
        const mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), { [mode]: true, 'segment-disabled': this.disabled, 'segment-scrollable': this.scrollable }) }));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "value": ["valueChanged"]
...
const Spinner = class {
    ...
    render() {
        ...
        return (h(Host, { class: Object.assign({}, createColorClasses$1(self.color), { [mode]: true, [`spinner-${spinnerName}`]: true, 'spinner-paused': !!self.paused || config.getBoolean('_testing') }), role: "progressbar", style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} }, svgs));
    }
...
export { AccountsForm as budgific_ig_accounts_form, Calculator as budgific_ig_calculator, GeneralForm as budgific_ig_general_form, InfoButton as budgific_ig_info_button, MortgageForm as budgific_ig_mortgage_form, RRSPForm as budgific_ig_rrsp_form, Schedule as budgific_ig_schedule, ScheduleChartComponent as budgific_ig_schedule_chart, ScheduleTableComponent as budgific_ig_schedule_table, StepperItem as budgific_ig_stepper_item, InvestmentGuide as budgific_investment_guide, Alert as ion_alert, Backdrop as ion_backdrop, Button as ion_button, Card as ion_card, CardContent as ion_card_content, CardHeader as ion_card_header, CardTitle as ion_card_title, Checkbox as ion_checkbox, Col as ion_col, Grid as ion_grid, Icon as ion_icon, Input as ion_input, Item as ion_item, Label as ion_label, Note as ion_note, Popover as ion_popover, RippleEffect as ion_ripple_effect, Row as ion_row, Segment$1 as ion_segment, SegmentButton as ion_segment_button, SkeletonText as ion_skeleton_text, Spinner as ion_spinner, Text as ion_text };
