...
const index$1 = require('./index-f13a2988.js');
...
const InvestmentGuideValueLabel = {
    [InvestmentGuideValueKey.amount]: 'Amount',
...
const getInvestmentGuideValueConstraints = (presence = true) => ({
...
const AccountsForm = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.valueChanged = core.createEvent(this, "valueChanged", 5);
    }
    handleChange(e) {
    ...
    render() {
        return (core.h(core.Host, null, core.h("ion-card", null, core.h("ion-card-header", null, core.h("ion-card-title", null, "Select Accounts")), this.renderAccounts(), this.renderError(this.error))));
    }
    renderAccounts() {
        return Object.keys(AccountsFormValueKey).map(this.renderAccountItem.bind(this));
    }
    renderAccountItem(key) {
        return (core.h("ion-item", { class: this.error ? 'ion-invalid' : '' }, core.h("ion-checkbox", { slot: "start", value: key, checked: this.value[key], onIonChange: this.handleChange.bind(this) }), core.h("ion-label", null, AccountLabel[key])));
    }
    renderError(error) {
        return error ? core.h("ion-card-content", null, core.h("ion-text", { color: "danger" }, error)) : null;
    }
    static get style() { return ".ion-invalid{--border-color:var(--highlight-color-invalid)}.ion-color-danger{color:var(--ion-color-danger)}"; }
};
...
class WebWorkerProxy extends WebWorker {
    constructor(publicPath) {
        super(publicPath);
...
const Calculator = class {
    constructor(hostRef) {
        ...
        this.loading = true;
        this.today = Date.now();
        this.valueChange = core.createEvent(this, "valueChange", 5);
        this.configClick = core.createEvent(this, "configClick", 5);
        this.publicPath = core.getContext(this, "publicPath");
    }
    ...
    render() {
        return (core.h(core.Host, null, this.data ? this.renderCalculator() : null));
    }
    renderCalculator() {
        return (core.h("div", null, core.h("ion-card", null, core.h("ion-item", { class: this.errors[InvestmentGuideValueKey.amount] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Amount"), core.h("ion-input", { value: this.data.amount.toString(), onIonChange: this.handleAmountChange.bind(this) }), core.h("ion-button", { slot: "end", fill: "clear", size: "default", onClick: () => this.configClick.emit() }, core.h("ion-icon", { name: "cog", slot: "icon-only" }))), this.renderError(InvestmentGuideValueKey.amount)), core.h("ion-card", null, core.h("ion-item", null, core.h("ion-icon", { name: "options", slot: "start" }), core.h("ion-label", null, "Parameters"), core.h("ion-button", { slot: "end", fill: "clear", size: "default", onClick: this.presentAlertCheckbox.bind(this) }, core.h("ion-icon", { name: "add", slot: "icon-only" }))), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.marginalTaxRate], ValueKey.marginalTaxRate, 1, 1, 50), this.renderError(ValueKey.marginalTaxRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.inflationRate], ValueKey.inflationRate, 0.25, 0.25, 20), this.renderError(ValueKey.inflationRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.investmentRate], ValueKey.investmentRate, 1, 0, 50), this.renderError(ValueKey.investmentRate), this.renderNumberStepper(InvestmentGuideValueLabel[ValueKey.investmentHorizon], ValueKey.investmentHorizon, 1, 1, 100), this.renderError(ValueKey.investmentHorizon), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.horizonMarginalTaxRate], ValueKey.horizonMarginalTaxRate, 1, 0, 50), this.renderError(ValueKey.horizonMarginalTaxRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.horizonEffectiveTaxRate], ValueKey.horizonEffectiveTaxRate, 1, 0, 50), this.renderError(ValueKey.horizonEffectiveTaxRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.mortgageRate], ValueKey.mortgageRate, 0.25, 0.25, 50), this.renderError(ValueKey.mortgageRate), this.renderRRSPReinvestTaxReturnItem()), core.h("ion-card", null, this.renderMortgageItem(this.data.mortgage), this.renderTFSAItem(this.data.tfsa), this.renderRRSPItem(this.data.rrsp), this.renderNonRegisteredItem(this.data.nonRegistered)), core.h("ion-card", null, core.h("ion-card-content", null, core.h("budgific-ig-schedule", { loading: this.loading, mortgage: this.mortgageData, rrsp: this.rrspData, tfsa: this.tfsaData, nonRegistered: this.nonRegisteredData })))));
    }
    renderRRSPReinvestTaxReturnItem() {
        return this.options[InvestmentGuideValueKey.reinvestTaxReturn] || this.errors[InvestmentGuideValueKey.reinvestTaxReturn] ? [(core.h("ion-item", { class: this.errors[InvestmentGuideValueKey.amount] ? 'ion-invalid' : '' }, core.h("ion-checkbox", { slot: "start", checked: this.data.reinvestTaxReturn, onIonChange: this.handleReinvestTaxReturnChange.bind(this) }), core.h("ion-label", null, "RRSP Reinvest Tax Return"), core.h("info-button", { slot: "end" }, core.h("p", null, "Reinvest the tax return."))))] : null;
    }
    renderFutureValue(value) {
        return !this.loading ? (core.h("ion-note", { slot: "end", style: { 'font-size': '15px' } }, Utils.currency(value))) : (core.h("ion-skeleton-text", { animated: true, style: { height: '17px', width: '72px' } }));
    }
    renderMortgageItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.mortgage } }), core.h("ion-label", null, AccountLabel.mortgage), this.renderFutureValue(this.mortgageFutureValue))) : null;
    }
    renderTFSAItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.tfsa } }), core.h("ion-label", null, AccountLabel.tfsa), this.renderFutureValue(this.tfsaFutureValue))) : null;
    }
    renderRRSPItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.rrsp } }), core.h("ion-label", null, AccountLabel.rrsp), this.renderFutureValue(this.rrspFutureValue))) : null;
    }
    renderNonRegisteredItem(show) {
        return show ? (core.h("ion-item", null, core.h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.nonRegistered } }), core.h("ion-label", null, AccountLabel.nonRegistered), this.renderFutureValue(this.nonRegisteredFutureValue))) : null;
    }
    renderPercentStepper(label, key, step, min, max) {
        return this.options[key] || this.errors[key] ? (core.h("budgific-ig-stepper-item", { label: label, value: this.percent(key), step: step, min: min, max: max, onValueChange: this.handleStepperPercentChange.bind(this, key) })) : null;
    }
    renderNumberStepper(label, key, step, min, max) {
        return this.options[key] || this.errors[key] ? (core.h("budgific-ig-stepper-item", { label: label, value: this.data[key], step: step, min: min, max: max, onValueChange: this.handleStepperChange.bind(this, key) })) : null;
    }
    renderError(key) {
        return this.errors[key] ? core.h("ion-item", { class: "error-item" }, core.h("ion-text", null, this.errors[key])) : null;
    }
    static get watchers() { return {
        "value": ["dataWatchHandler"]
    }; }
    static get style() { return ".padding-horizontal{padding:0 10px}.ion-invalid{--border-color:var(--highlight-color-invalid)}.error-item,.ion-color-danger{color:var(--ion-color-danger)}.error-item{--min-height:20px;font-size:80%}canvas{-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none}"; }
};

const GeneralForm = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.errors = {};
        this.valueChanged = core.createEvent(this, "valueChanged", 5);
    ...
    render() {
        return (core.h(core.Host, null, core.h("ion-card", null, core.h("ion-card-header", null, core.h("ion-card-title", null, "Details")), core.h("ion-item", { class: this.errors[GeneralFormValueKey.marginalTaxRate] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Current Marginal Tax Rate"), core.h("ion-input", { value: this.percent(GeneralFormValueKey.marginalTaxRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.marginalTaxRate) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "A marginal tax rate is the tax rate incurred on each additional dollar of income. ", core.h("br", null), "You can get the number from ", core.h("a", { href: "https://simpletax.ca/calculator", target: "_blank" }, "Simple Tax Calculator"), "."))), this.renderError(GeneralFormValueKey.marginalTaxRate), core.h("ion-item", { class: this.errors[GeneralFormValueKey.inflationRate] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Inflation Rate"), core.h("ion-input", { value: this.percent(GeneralFormValueKey.inflationRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.inflationRate) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "Inflation is the increase in the prices of goods and services over time. In July 2019 Canadian inflation rate was 2%"))), this.renderError(GeneralFormValueKey.inflationRate), core.h("ion-item", { class: this.errors[GeneralFormValueKey.investmentRate] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Yearly Investment Rate of Return"), core.h("ion-input", { value: this.percent(GeneralFormValueKey.investmentRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.investmentRate) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "A rate of return (RoR) is the net gain or loss on an investment over a year."))), this.renderError(GeneralFormValueKey.investmentRate), core.h("ion-item", { class: this.errors[GeneralFormValueKey.investmentHorizon] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Investment Horizon"), core.h("ion-input", { value: this.value.investmentHorizon.toString(), onIonChange: this.handleNumberValueChange.bind(this, GeneralFormValueKey.investmentHorizon) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "Investment horizon is the total length of time that you expect to hold a security or a portfolio."))), this.renderError(GeneralFormValueKey.investmentHorizon), core.h("ion-item", { class: this.errors[GeneralFormValueKey.horizonMarginalTaxRate] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Horizon Marginal Tax Rate"), core.h("ion-input", { value: this.percent(GeneralFormValueKey.horizonMarginalTaxRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.horizonMarginalTaxRate) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "A horizon marginal tax rate is the tax rate incurred on each additional dollar of income when you will withdraw a security or a portfolio. ", core.h("br", null), "You can get the number from ", core.h("a", { href: "https://simpletax.ca/calculator", target: "_blank" }, "Simple Tax Calculator"), "."))), this.renderError(GeneralFormValueKey.horizonMarginalTaxRate), core.h("ion-item", { class: this.errors[GeneralFormValueKey.horizonEffectiveTaxRate] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Horizon Actual Tax Rate"), core.h("ion-input", { value: this.percent(GeneralFormValueKey.horizonEffectiveTaxRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.horizonEffectiveTaxRate) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "A horizon marginal tax rate is the tax rate incurred on each additional dollar of income when you will withdraw a security or a portfolio. ", core.h("br", null), "You can get the number from ", core.h("a", { href: "https://simpletax.ca/calculator", target: "_blank" }, "Simple Tax Calculator"), "."))), this.renderError(GeneralFormValueKey.horizonEffectiveTaxRate))));
    }
    renderError(key) {
        return this.errors[key] ? core.h("ion-item", { class: "error-item" }, core.h("ion-text", null, this.errors[key])) : null;
    }
    static get style() { return ".ion-invalid{--border-color:var(--highlight-color-invalid)}.error-item,.ion-color-danger{color:var(--ion-color-danger)}.error-item{--min-height:20px;font-size:80%}"; }
};
...
const MortgageForm = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("ion-card", null, core.h("ion-card-header", null, core.h("ion-card-title", null, "Mortgage Details")), core.h("ion-item", { class: this.errors[MortgageFormValueKey.mortgageBalance] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Balance"), core.h("ion-input", { value: this.value.mortgageBalance.toString(), onIonChange: this.handleNumberValueChange.bind(this, MortgageFormValueKey.mortgageBalance) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "A mortgage balance is the current amount owed by you."))), this.renderError(MortgageFormValueKey.mortgageBalance), core.h("ion-item", { class: this.errors[MortgageFormValueKey.mortgageRate] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Rate"), core.h("ion-input", { value: this.percent(MortgageFormValueKey.mortgageRate), onIonChange: this.handlePercentValueChange.bind(this, MortgageFormValueKey.mortgageRate) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "A mortgage rate is the rate of interest charged on your mortgage."))), this.renderError(MortgageFormValueKey.mortgageRate), core.h("ion-item", { class: this.errors[MortgageFormValueKey.mortgageAmortization] ? 'ion-invalid' : '' }, core.h("ion-label", { position: "floating" }, "Amortization"), core.h("ion-input", { value: this.value.mortgageAmortization.toString(), onIonChange: this.handleNumberValueChange.bind(this, MortgageFormValueKey.mortgageAmortization) }), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "The amortization period refers to the length of time, in years, that you chooses to pay off a mortgage."))), this.renderError(MortgageFormValueKey.mortgageAmortization))));
    }
    renderError(key) {
        return this.errors[key] ? core.h("ion-item", { class: "error-item" }, core.h("ion-text", null, this.errors[key])) : null;
    }
...
const RRSPForm = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.reinvestTaxReturnChange = core.createEvent(this, "reinvestTaxReturnChange", 5);
    }
    handleChange(e) {
        this.reinvestTaxReturnChange.emit(e.detail.checked);
    }
    render() {
        return (core.h(core.Host, null, core.h("ion-card", null, core.h("ion-card-header", null, core.h("ion-card-title", null, "RRSP Details")), core.h("ion-item", { class: "item-multiple-inputs" }, core.h("ion-checkbox", { slot: "start", checked: this.reinvestTaxReturn, onIonChange: this.handleChange.bind(this) }), core.h("ion-label", null, "Reinvest Tax Return"), core.h("budgific-ig-info-button", { slot: "end" }, core.h("p", null, "The best approach is to reinvest the tax return that you receive when contributing to RRSP."))))));
    }
...
const Schedule = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("ion-segment", { value: Segment.graph, onIonChange: this.handleSegmentChange.bind(this) }, core.h("ion-segment-button", { value: Segment.graph }, core.h("ion-label", null, "Graph")), core.h("ion-segment-button", { value: Segment.table }, core.h("ion-label", null, "Table"))), core.h("budgific-ig-schedule-chart", { loading: this.loading, mortgage: this.mortgage ? this.mortgage.chartData : null, tfsa: this.tfsa ? this.tfsa.chartData : null, rrsp: this.rrsp ? this.rrsp.chartData : null, nonRegistered: this.nonRegistered ? this.nonRegistered.chartData : null, style: { display: this.segment === Segment.table ? 'none' : '' } }), this.renderTable(this.segment === Segment.table)));
    }
    renderTable(show) {
        return show ? (core.h("budgific-ig-schedule-table", { loading: this.loading, mortgage: this.mortgage ? this.mortgage.chartData : null, tfsa: this.tfsa ? this.tfsa.chartData : null, rrsp: this.rrsp ? this.rrsp.chartData : null, nonRegistered: this.nonRegistered ? this.nonRegistered.chartData : null })) : null;
    }
    static get style() { return ""; }
};
...
var chartjsPluginZoom = createCommonjsModule(function (module, exports) {
/*!
 * @license
 * chartjs-plugin-zoom
 * http://chartjs.org/
 ...
 */
(function (global, factory) {
 module.exports = factory(Chart, hammer) ;
}(commonjsGlobal, function (Chart, Hammer) {
...
const ScheduleChartComponent = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.chartOptions = {
            type: 'line',
    ...
    updateLabels() {
        ...
        if (this.chartOptions.data.labels.length !== maxLength && maxLength > 0) {
            this.chartOptions.data.labels = Array.apply(null, Array(maxLength)).map((_x, i) => hooks(this.today).add(i, 'year').year());
        }
    }
    ...
    render() {
        return (core.h(core.Host, null, core.h("div", { class: "chart-spinner", style: { 'display': this.loading ? 'flex' : 'none' } }, core.h("ion-spinner", { name: "lines", color: "primary" })), core.h("canvas", { style: { 'visibility': this.showChart() }, ref: (charts) => this.charts = charts })));
    }
    showChart() {
    ...
    static get watchers() { return {
        ...
        "tfsa": ["updateTFSAData"],
        "rrsp": ["updateRRSPData"],
        "nonRegistered": ["updateNonRegisteredData"]
    }; }
    static get style() { return ":host{display:block;height:100%;width:calc(100% + 28px);position:relative;padding-top:16px;margin-left:-14px;margin-right:-14px}.chart-spinner{width:100%;height:100%;position:absolute;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;left:0;top:0}"; }
};

const ScheduleTableComponent = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.today = Date.now();
    }
    render() {
        return (core.h(core.Host, null, core.h("ion-grid", null, core.h("ion-row", null, core.h("ion-col", null, core.h("h3", null, "Year")), core.h("ion-col", null, core.h("h3", null, "Mortgage")), core.h("ion-col", null, core.h("h3", null, "TFSA")), core.h("ion-col", null, core.h("h3", null, "RRSP")), core.h("ion-col", null, core.h("h3", null, "Non Registered"))), this.renderRows())));
    }
    renderRows() {
    ...
    renderRow(index) {
        const year = hooks(this.today).add(index, 'year').year();
        return (core.h("ion-row", null, core.h("ion-col", null, core.h("div", null, year)), core.h("ion-col", null, core.h("div", null, this.mortgage[index] ? Utils.currency(this.mortgage[index]) : '')), core.h("ion-col", null, core.h("div", null, this.tfsa[index] ? Utils.currency(this.tfsa[index]) : '')), core.h("ion-col", null, core.h("div", null, this.rrsp[index] ? Utils.currency(this.rrsp[index]) : '')), core.h("ion-col", null, core.h("div", null, this.nonRegistered[index] ? Utils.currency(this.nonRegistered[index]) : ''))));
    }
    getDataLength(type) {
        return this[type] ? this[type].length : 0;
    }
    static get style() { return ":host{display:block;overflow:overlay}ion-row{border-bottom:1px solid rgba(0,0,0,.13);min-width:-webkit-max-content;min-width:-moz-max-content;min-width:max-content}ion-col>div{white-space:nowrap}"; }
};
...
const StepperItem = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("ion-item", { class: itemClass }, core.h("ion-label", { position: "floating" }, this.label), core.h("ion-input", { value: this.stateValue.toString(), onIonChange: (e) => this.handleChange(e), required: true }), core.h("ion-button", { slot: "end", fill: "clear", size: "default", onClick: this.handleDecrease.bind(this) }, core.h("ion-icon", { name: "arrow-dropleft-circle", slot: "icon-only" })), core.h("ion-button", { class: "no-margin", slot: "end", fill: "clear", size: "default", onClick: this.handleIncrease.bind(this) }, core.h("ion-icon", { name: "arrow-dropright-circle", slot: "icon-only" }))), this.renderError(this.error)));
    }
    renderError(error) {
        return error ? core.h("ion-item", { class: "error-item" }, core.h("ion-text", null, error)) : null;
    }
    static get watchers() { return {
        "value": ["watch"]
    }; }
    static get style() { return ".no-margin{margin-left:0}"; }
};
...
const Popover = class {
    ...
    async present() {
        ...
        return overlays.present(this, 'popoverEnter', iosEnterAnimation$1, mdEnterAnimation$1, this.event);
    }
    /**
    ...
    async dismiss(data, role) {
        const shouldDismiss = await overlays.dismiss(this, data, role, 'popoverLeave', iosLeaveAnimation$1, mdLeaveAnimation$1, this.event);
        if (shouldDismiss) {
...
const Spinner = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign({}, theme.createColorClasses(self.color), { [mode]: true, [`spinner-${spinnerName}`]: true, 'spinner-paused': !!self.paused || core.config.getBoolean('_testing') }), role: "progressbar", style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} }, svgs));
    }
...
exports.budgific_ig_accounts_form = AccountsForm;
exports.budgific_ig_calculator = Calculator;
exports.budgific_ig_general_form = GeneralForm;
exports.budgific_ig_info_button = InfoButton;
exports.budgific_ig_mortgage_form = MortgageForm;
exports.budgific_ig_rrsp_form = RRSPForm;
exports.budgific_ig_schedule = Schedule;
exports.budgific_ig_schedule_chart = ScheduleChartComponent;
exports.budgific_ig_schedule_table = ScheduleTableComponent;
exports.budgific_ig_stepper_item = StepperItem;
exports.budgific_investment_guide = InvestmentGuide;
