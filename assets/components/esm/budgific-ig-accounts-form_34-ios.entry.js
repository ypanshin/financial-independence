...
const ScheduleTableComponent = class {
    ...
    renderRow(index) {
        ...
        return (h("ion-row", null, h("ion-col", null, year), h("ion-col", null, this.mortgage[index] ? Utils.currency(this.mortgage[index]) : ''), h("ion-col", null, this.tfsa[index] ? Utils.currency(this.tfsa[index]) : ''), h("ion-col", null, this.rrsp[index] ? Utils.currency(this.rrsp[index]) : ''), h("ion-col", null, this.nonRegistered[index] ? Utils.currency(this.nonRegistered[index]) : '')));
    }
    getDataLength(type) {
