...
var _b, _c, _e;
import { r as registerInstance, c as createEvent, h, H as Host, d as getElement, e as getIonMode$1, f as getAssetPath, i as getMode, j as readTask, w as writeTask, k as config } from './core-d377b9a5.js';
import { B as BACKDROP, i as isCancel, p as prepareOverlay, a as present, d as dismiss, e as eventMethod, s as safeCall } from './overlays-c7dfdb33.js';
import { s as sanitizeDOMString } from './index-d6bd1e69.js';
import { g as getClassMap, o as openURL, c as createColorClasses$1, h as hostContext } from './theme-215399f6.js';
import { c as createAnimation } from './animation-ed5fbd06.js';
import { GESTURE_CONTROLLER } from './index-9b8e1c51.js';
import { n as now$1, h as hasShadowDom, f as findItemLabel, r as renderHiddenInput, d as debounceEvent } from './helpers-45f2b621.js';
...
var AccountLabel = (_b = {},
    _b[AccountType.mortgage] = 'Mortgage',
    _b[AccountType.tfsa] = 'TFSA',
    _b[AccountType.rrsp] = 'RRSP',
    _b[AccountType.nonRegistered] = 'Non Registered',
    _b);
var AccountColor = (_c = {},
    _c[AccountType.mortgage] = '#7189bf',
    _c[AccountType.tfsa] = '#df7599',
    _c[AccountType.rrsp] = '#ffc785',
    _c[AccountType.nonRegistered] = '#72d6c9',
    _c);
var AccountsFormValueKey;
(function (AccountsFormValueKey) {
    AccountsFormValueKey["mortgage"] = "mortgage";
    AccountsFormValueKey["tfsa"] = "tfsa";
    AccountsFormValueKey["rrsp"] = "rrsp";
    AccountsFormValueKey["nonRegistered"] = "nonRegistered";
})(AccountsFormValueKey || (AccountsFormValueKey = {}));
...
var validate = createCommonjsModule(function (module, exports) {
    ...
    (function (exports, module, define) {
        ...
        validate.validators = {
            ...
            length: function (value, options, attribute) {
                ...
                options = v.extend({}, this.options, options);
                var is = options.is, maximum = options.maximum, minimum = options.minimum, tokenizer = options.tokenizer || function (val) { return val; }, err, errors = [];
    ...
    /* istanbul ignore next */ module, null);
});
var GeneralFormValueKey;
(function (GeneralFormValueKey) {
    GeneralFormValueKey["marginalTaxRate"] = "marginalTaxRate";
    GeneralFormValueKey["investmentHorizon"] = "investmentHorizon";
    GeneralFormValueKey["horizonMarginalTaxRate"] = "horizonMarginalTaxRate";
    GeneralFormValueKey["horizonEffectiveTaxRate"] = "horizonEffectiveTaxRate";
    GeneralFormValueKey["inflationRate"] = "inflationRate";
    GeneralFormValueKey["investmentRate"] = "investmentRate";
})(GeneralFormValueKey || (GeneralFormValueKey = {}));
var MortgageFormValueKey;
(function (MortgageFormValueKey) {
    MortgageFormValueKey["mortgageRate"] = "mortgageRate";
    MortgageFormValueKey["mortgageBalance"] = "mortgageBalance";
    MortgageFormValueKey["mortgageAmortization"] = "mortgageAmortization";
    MortgageFormValueKey["mortgage"] = "mortgage";
})(MortgageFormValueKey || (MortgageFormValueKey = {}));
var InvestmentGuideValueKey;
...
var InvestmentGuideValueLabel = (_e = {},
    _e[InvestmentGuideValueKey.amount] = 'Amount',
    _e[GeneralFormValueKey.investmentHorizon] = 'Investment Horizon',
    _e[GeneralFormValueKey.marginalTaxRate] = 'Marginal Tax Rate',
    _e[GeneralFormValueKey.horizonMarginalTaxRate] = 'Horizon Marginal Tax Rate',
    _e[GeneralFormValueKey.horizonEffectiveTaxRate] = 'Horizon Effective Tax Rate',
    _e[GeneralFormValueKey.inflationRate] = 'Inflation Rate',
    _e[MortgageFormValueKey.mortgageRate] = 'Mortgage Rate',
    _e[MortgageFormValueKey.mortgageBalance] = 'Mortgage Balance',
    _e[MortgageFormValueKey.mortgageAmortization] = 'Mortgage Amortization',
    _e[GeneralFormValueKey.investmentRate] = 'Investment Rate',
    _e[InvestmentGuideValueKey.reinvestTaxReturn] = 'Reinvest Tax Return',
    _e);
validate.validators.accounts = function (_value, _options, _key, attributes) {
    var mortgageUnChecked = attributes && attributes.mortgage !== undefined && !attributes.mortgage;
    var nonRegisteredUnChecked = attributes && attributes.nonRegistered !== undefined && !attributes.nonRegistered;
    var rrspUnChecked = attributes && attributes.rrsp !== undefined && !attributes.rrsp;
    var tfsaUnChecked = attributes && attributes.tfsa !== undefined && !attributes.tfsa;
    return mortgageUnChecked &&
        nonRegisteredUnChecked &&
        rrspUnChecked &&
        tfsaUnChecked ? 'At least one account should be selected.' : undefined;
};
var getInvestmentGuideValueConstraints = function (presence) {
    var _b;
    if (presence === void 0) { presence = true; }
    return (_b = {},
        _b[InvestmentGuideValueKey.amount] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
            },
        },
        _b[GeneralFormValueKey.investmentHorizon] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                onlyInteger: true,
                greaterThan: 0,
        ...
        _b[GeneralFormValueKey.marginalTaxRate] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
                lessThan: 60,
        ...
        _b[GeneralFormValueKey.horizonMarginalTaxRate] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
                lessThan: 60,
        ...
        _b[GeneralFormValueKey.horizonEffectiveTaxRate] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
                lessThan: 60,
        ...
        _b[GeneralFormValueKey.inflationRate] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
                lessThan: 60,
        ...
        _b[MortgageFormValueKey.mortgageRate] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
                lessThan: 50,
        ...
        _b[MortgageFormValueKey.mortgageBalance] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
            },
        },
        _b[MortgageFormValueKey.mortgageAmortization] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                onlyInteger: true,
                greaterThan: 0,
        ...
        _b[GeneralFormValueKey.investmentRate] = {
            presence: presence ? { allowEmpty: false } : undefined,
            numericality: {
                greaterThan: 0,
                lessThan: 50,
        ...
        _b[AccountsFormValueKey.mortgage] = {
            accounts: {}
        },
        _b[AccountsFormValueKey.nonRegistered] = {
            accounts: {}
        },
        _b[AccountsFormValueKey.rrsp] = {
            accounts: {}
        },
        _b[AccountsFormValueKey.tfsa] = {
            accounts: {}
        },
        _b);
};
var AccountsForm = /** @class */ (function () {
    function AccountsForm(hostRef) {
        registerInstance(this, hostRef);
        this.valueChanged = createEvent(this, "valueChanged", 5);
    }
    AccountsForm.prototype.handleChange = function (e) {
        var _b;
        var _c = e.detail, checked = _c.checked, value = _c.value;
        var data = Object.assign(Object.assign({}, this.value), (_b = {}, _b[value] = checked, _b));
        var validation = validate(data, getInvestmentGuideValueConstraints());
    ...
    AccountsForm.prototype.render = function () {
        return (h(Host, null, h("ion-card", null, h("ion-card-header", null, h("ion-card-title", null, "Select Accounts")), this.renderAccounts(), this.renderError(this.error))));
    };
    AccountsForm.prototype.renderAccounts = function () {
        return Object.keys(AccountsFormValueKey).map(this.renderAccountItem.bind(this));
    };
    AccountsForm.prototype.renderAccountItem = function (key) {
        return (h("ion-item", { class: this.error ? 'ion-invalid' : '' }, h("ion-checkbox", { slot: "start", value: key, checked: this.value[key], onIonChange: this.handleChange.bind(this) }), h("ion-label", null, AccountLabel[key])));
    };
    AccountsForm.prototype.renderError = function (error) {
        return error ? h("ion-card-content", null, h("ion-text", { color: "danger" }, error)) : null;
    };
    Object.defineProperty(AccountsForm, "style", {
        get: function () { return ".ion-invalid{--border-color:var(--highlight-color-invalid)}.ion-color-danger{color:var(--ion-color-danger)}"; },
        enumerable: true,
        configurable: true
    });
    return AccountsForm;
...
var Chart = createCommonjsModule(function (module, exports) {
    ...
    (function (global, factory) {
        module.exports = factory(function () { try {
            return hooks;
        }
        catch (e) { } }());
...
var CalculatorData = /** @class */ (function () {
    function CalculatorData() {
    }
    CalculatorData.prototype.yearlyReduce = function (today, data, amount, getValue) {
        var dataByYears = data.reduce(function (acc, item, i) {
            var year = hooks(today).add(item.period, 'month').year();
            acc[year] = acc[year] || [];
            acc[year].push(getValue(item, i));
            return acc;
        }, {});
        var sum = big(0);
        return Object.keys(dataByYears).map(function (key) {
            sum = dataByYears[key].reduce(function (acc, num) { return acc.plus(num); }, big(0)).plus(sum);
            return +sum.plus(amount).round(2);
        });
    };
    CalculatorData.prototype.yearlyReduce1 = function (today, data, getValue) {
        var dataByYears = data.reduce(function (acc, item, i) {
            var date = hooks(today).add(item.period, 'month');
            var year = date.year();
            acc[year] = getValue(item, i);
            return acc;
        }, {});
        return Object.keys(dataByYears).map(function (key) { return +big(dataByYears[key]).round(2); });
    };
    CalculatorData.prototype.shouldRegenerate = function (params) {
        var _this = this;
        if (!this.params || !!Object.keys(this.params).find(function (key) { return _this.params[key] !== params[key]; })) {
...
var Formula = /** @class */ (function () {
    ...
    Formula.amortizationSchedule = function (rate, periods, value, lump, lumpPeriod) {
        var payment = big(-Formula.PMT(rate, periods, value));
        var amortization = [];
        var balance = big(value);
        for (var period = 1; period <= periods; period++) {
            var interest = balance.times(rate);
            var principal = payment.minus(interest);
    ...
    Formula.gainSchedule = function (rate, periods, value) {
        var schedule = [];
        var monthlyRate = big(rate).div(12);
        var balance = big(value);
        for (var period = 1; period <= periods; period++) {
            var gain = balance.times(monthlyRate);
    ...
    Formula.semiAnnuallyRate = function (rate) {
    ...
    Formula.FV = function (rate, periods, payment, value, type) {
        ...
        if (type === void 0) { type = FormulaType.ZERO; }
        ...
        if (rate === 0) {
            ...
            var term = big(1).plus(rate).pow(periods);
            if (type === FormulaType.ONE) {
    ...
    Formula.PMT = function (rate, periods, present, future, type) {
        ...
        if (rate === 0) {
            ...
            var term = big(Math.pow(+big(1).plus(rate), periods));
            if (type === FormulaType.ONE) {
...
var TFSAData = /** @class */ (function (_super) {
    __extends(TFSAData, _super);
    function TFSAData(today) {
        var _this = _super.call(this) || this;
        _this.today = today;
        return _this;
    }
    TFSAData.prototype.generateData = function (value) {
        if (this.shouldRegenerate(value)) {
            if (value.tfsa && value.investmentRate && value.investmentHorizon && value.amount) {
                var periods = +big(value.investmentHorizon).times(12);
                var rate = +big(value.investmentRate).minus(value.inflationRate);
                var amortization = Formula.gainSchedule(rate, periods, value.amount);
                this.futureValue = amortization[amortization.length - 1].value;
                this.chartData = this.yearlyReduce1(this.today, amortization, function (item) { return item.value; });
            }
            else {
    ...
    TFSAData.prototype.copyParams = function (params) {
        var investmentRate = params.investmentRate, investmentHorizon = params.investmentHorizon, amount = params.amount, inflationRate = params.inflationRate;
        this.params = { investmentRate: investmentRate, investmentHorizon: investmentHorizon, amount: amount, inflationRate: inflationRate };
    };
    return TFSAData;
}(CalculatorData));
var RRSPData = /** @class */ (function (_super) {
    __extends(RRSPData, _super);
    function RRSPData(today) {
        var _this = _super.call(this) || this;
        _this.today = today;
        return _this;
    }
    RRSPData.prototype.generateData = function (value) {
        var _this = this;
        if (this.shouldRegenerate(value)) {
            if (value.rrsp &&
                ...
                var periods = +big(value.investmentHorizon).times(12);
                var rate = +big(value.investmentRate).minus(value.inflationRate);
                var rrspAmount = value.amount;
                if (value.reinvestTaxReturn) {
                    rrspAmount = +big(value.marginalTaxRate).times(value.amount).plus(value.amount);
                }
                var amortization = Formula.gainSchedule(rate, periods, rrspAmount);
                this.futureValue = this.afterTaxes(amortization[amortization.length - 1].value, value.horizonEffectiveTaxRate);
                this.chartData = this.yearlyReduce1(this.today, amortization, function (item) { return _this.afterTaxes(item.value, value.horizonEffectiveTaxRate); });
            }
            else {
                this.chartData = undefined;
            }
    ...
    RRSPData.prototype.afterTaxes = function (value, horizonEffectiveTaxRate) {
        var bigValue = big(value);
        return +bigValue.minus(bigValue.times(horizonEffectiveTaxRate));
    };
    RRSPData.prototype.copyParams = function (params) {
        var investmentRate = params.investmentRate, investmentHorizon = params.investmentHorizon, amount = params.amount, marginalTaxRate = params.marginalTaxRate, horizonEffectiveTaxRate = params.horizonEffectiveTaxRate, inflationRate = params.inflationRate, reinvestTaxReturn = params.reinvestTaxReturn;
        this.params = { investmentRate: investmentRate, investmentHorizon: investmentHorizon, amount: amount, marginalTaxRate: marginalTaxRate, horizonEffectiveTaxRate: horizonEffectiveTaxRate, inflationRate: inflationRate, reinvestTaxReturn: reinvestTaxReturn };
    };
    return RRSPData;
}(CalculatorData));
var NonRegisteredData = /** @class */ (function (_super) {
    __extends(NonRegisteredData, _super);
    function NonRegisteredData(today) {
        var _this = _super.call(this) || this;
        _this.today = today;
        return _this;
    }
    NonRegisteredData.prototype.generateData = function (value) {
        var _this = this;
        if (this.shouldRegenerate(value)) {
            if (value.nonRegistered && value.investmentRate && value.investmentHorizon && value.amount && value.horizonMarginalTaxRate) {
                ...
                this.chartData = this.yearlyReduce1(this.today, amortization, function (item) { return _this.afterTax(item.value, value.amount, value.horizonMarginalTaxRate); });
            }
            else {
                this.chartData = undefined;
            }
    ...
    NonRegisteredData.prototype.afterTax = function (value, amount, horizonMarginalTaxRate) {
        var bigValue = big(value);
        var gain = bigValue.minus(amount);
        var taxes = gain.times(horizonMarginalTaxRate).div(2);
        return +bigValue.minus(taxes);
    };
    NonRegisteredData.prototype.copyParams = function (params) {
        var investmentRate = params.investmentRate, investmentHorizon = params.investmentHorizon, amount = params.amount, horizonMarginalTaxRate = params.horizonMarginalTaxRate, inflationRate = params.inflationRate;
        this.params = { investmentRate: investmentRate, investmentHorizon: investmentHorizon, amount: amount, horizonMarginalTaxRate: horizonMarginalTaxRate, inflationRate: inflationRate };
    };
    return NonRegisteredData;
}(CalculatorData));
var MortgageData = /** @class */ (function (_super) {
    __extends(MortgageData, _super);
    function MortgageData(today) {
        var _this = _super.call(this) || this;
        _this.today = today;
        return _this;
    }
    MortgageData.prototype.generateData = function (value) {
        var _this = this;
        if (this.shouldRegenerate(value)) {
            if (value.mortgage && value.mortgageBalance && value.mortgageRate && value.investmentHorizon && value.amount && value.mortgageAmortization) {
                var semiAnnuallyRate = Formula.semiAnnuallyRate(value.mortgageRate);
                var monthlyInflationRate_1 = big(value.inflationRate).div(12);
                var periods = +big(value.mortgageAmortization).times(12);
                var amortizationBefore = Formula.amortizationSchedule(semiAnnuallyRate, periods, value.mortgageBalance);
                var interestsBefore = amortizationBefore.reduce(function (acc, amor) { return acc.plus(amor.interest).minus(monthlyInflationRate_1.times(amor.interest)); }, big(0));
                var amortizationAfter_1 = Formula.amortizationSchedule(semiAnnuallyRate, periods, value.mortgageBalance, value.amount, 1);
                var interestsAfter = amortizationAfter_1.reduce(function (acc, amor) { return acc.plus(amor.interest).minus(monthlyInflationRate_1.times(amor.interest)); }, big(0));
                this.futureValue = +interestsBefore.minus(interestsAfter).plus(value.amount);
                var dataByYears_1 = amortizationBefore.reduce(function (acc, itemBefore, i) {
                    var year = hooks(_this.today).add(itemBefore.period, 'month').year();
                    acc[year] = acc[year] || [];
                    var interestsBefore = big(itemBefore.interest).minus(monthlyInflationRate_1.times(itemBefore.interest));
                    var itemAfter = amortizationAfter_1[i];
                    var interestsAfter = big(itemAfter.interest).minus(monthlyInflationRate_1.times(itemAfter.interest));
                    acc[year].push(interestsBefore.minus(interestsAfter));
                    return acc;
                }, {});
                var sum_1 = big(0);
                this.chartData = Object.keys(dataByYears_1).map(function (key) {
                    sum_1 = dataByYears_1[key].reduce(function (acc, num) { return acc.plus(num); }, big(0)).plus(sum_1);
                    return +sum_1.plus(value.amount).round(2);
                });
            }
            else {
                this.chartData = undefined;
    ...
    MortgageData.prototype.copyParams = function (params) {
        var mortgageBalance = params.mortgageBalance, mortgageRate = params.mortgageRate, investmentHorizon = params.investmentHorizon, amount = params.amount, mortgageAmortization = params.mortgageAmortization, inflationRate = params.inflationRate;
        this.params = { mortgageBalance: mortgageBalance, mortgageRate: mortgageRate, investmentHorizon: investmentHorizon, amount: amount, mortgageAmortization: mortgageAmortization, inflationRate: inflationRate };
    };
    return MortgageData;
}(CalculatorData));
var ValueKey = Object.assign(Object.assign(Object.assign({}, GeneralFormValueKey), InvestmentGuideValueKey), MortgageFormValueKey);
var Calculator = /** @class */ (function () {
    function Calculator(hostRef) {
        var _b;
        registerInstance(this, hostRef);
        this.options = (_b = {},
            _b[ValueKey.investmentHorizon] = false,
            _b[ValueKey.investmentRate] = false,
            _b[ValueKey.horizonMarginalTaxRate] = false,
            _b[ValueKey.horizonEffectiveTaxRate] = false,
            _b[ValueKey.marginalTaxRate] = false,
            _b[ValueKey.inflationRate] = false,
            _b[ValueKey.mortgageRate] = false,
            _b[ValueKey.reinvestTaxReturn] = false,
            _b);
        this.chartOptions = {
            type: 'line',
        ...
        this.errors = {};
        this.today = Date.now();
        this.valueChange = createEvent(this, "valueChange", 5);
        this.configClick = createEvent(this, "configClick", 5);
    }
    Calculator.prototype.dataWatchHandler = function (newValue) {
        this.processData(newValue);
    };
    Calculator.prototype.componentDidLoad = function () {
        this.processData(this.value, 200);
    };
    Calculator.prototype.componentDidRender = function () {
        if (!this.barChart && this.charts) {
            this.barChart = new Chart(this.charts, this.chartOptions);
        }
    };
    Calculator.prototype.processData = function (value, delay) {
        var _this = this;
        if (delay === void 0) { delay = 0; }
        this.data = value;
        if (value) {
            setTimeout(function () {
                _this.mortgageData = _this.mortgageData || new MortgageData(_this.today);
                _this.mortgageData.generateData(value);
                _this.tfsaData = _this.tfsaData || new TFSAData(_this.today);
                _this.tfsaData.generateData(value);
                _this.rrspData = _this.rrspData || new RRSPData(_this.today);
                _this.rrspData.generateData(value);
                _this.nonRegisteredData = _this.nonRegisteredData || new NonRegisteredData(_this.today);
                _this.nonRegisteredData.generateData(value);
                _this.processGraphData();
            }, delay);
        }
    };
    Calculator.prototype.processGraphData = function () {
        var _this = this;
        var maxLength = Math.max(this.mortgageData.chartData ? this.mortgageData.chartData.length : 0, this.tfsaData.chartData ? this.tfsaData.chartData.length : 0, this.rrspData.chartData ? this.rrspData.chartData.length : 0, this.nonRegisteredData.chartData ? this.nonRegisteredData.chartData.length : 0);
        if (!this.chartOptions.data.labels || this.chartOptions.data.labels.length !== maxLength) {
            var labels = Array.apply(null, Array(maxLength)).map(function (_x, i) { return hooks(_this.today).add(i, 'year').year(); });
            this.chartOptions.data.labels = labels;
        }
        var dataSets = this.chartOptions.data.datasets;
        if (this.mortgageData.chartData) {
            var datasetIdx = dataSets.findIndex(function (d) { return d.label === AccountLabel.mortgage; });
            if (datasetIdx > -1) {
        ...
        if (this.tfsaData.chartData) {
            var datasetIdx = dataSets.findIndex(function (d) { return d.label === AccountLabel.tfsa; });
            if (datasetIdx > -1) {
        ...
        if (this.rrspData.chartData) {
            var datasetIdx = dataSets.findIndex(function (d) { return d.label === AccountLabel.rrsp; });
            if (datasetIdx > -1) {
        ...
        if (this.nonRegisteredData.chartData) {
            var datasetIdx = dataSets.findIndex(function (d) { return d.label === AccountLabel.nonRegistered; });
            if (datasetIdx > -1) {
    ...
    Calculator.prototype.createDataset = function (type, data) {
        return {
    ...
    Calculator.prototype.isValid = function (value, key) {
        var _b, _c;
        var invalid = validate.single(value, getInvestmentGuideValueConstraints()[key]);
        if (invalid) {
            this.errors = Object.assign(Object.assign({}, this.errors), (_b = {}, _b[key] = invalid[0], _b));
            return false;
        }
        else {
            this.errors = Object.assign(Object.assign({}, this.errors), (_c = {}, _c[key] = undefined, _c));
            return true;
        }
    };
    Calculator.prototype.handleAmountChange = function (e) {
        if (this.isValid(e.detail.value, InvestmentGuideValueKey.amount)) {
            var data = Object.assign(Object.assign({}, this.data), { amount: e.detail.value });
            this.valueChange.emit(data);
        }
    };
    Calculator.prototype.handleStepperPercentChange = function (key, e) {
        var _b;
        if (this.isValid(e.detail, key)) {
            var value = +big(e.detail).div(100);
            var data = Object.assign(Object.assign({}, this.data), (_b = {}, _b[key] = value, _b));
            this.valueChange.emit(data);
        }
    };
    Calculator.prototype.handleStepperChange = function (key, e) {
        var _b;
        if (this.isValid(e.detail, key)) {
            var data = Object.assign(Object.assign({}, this.data), (_b = {}, _b[key] = e.detail, _b));
            this.valueChange.emit(data);
        }
    };
    Calculator.prototype.handleReinvestTaxReturnChange = function (e) {
        var data = Object.assign(Object.assign({}, this.data), { reinvestTaxReturn: e.detail.checked });
        this.valueChange.emit(data);
    };
    Calculator.prototype.percent = function (key) {
        return +big(this.data[key]).times(100);
    };
    Calculator.prototype.presentAlertCheckbox = function () {
        var _this = this;
        var alert = document.createElement('ion-alert');
        alert.header = 'Parameters';
        alert.inputs = Object.keys(this.options).map(function (key) { return ({
            type: 'checkbox',
            label: InvestmentGuideValueLabel[key],
            value: key,
            checked: _this.options[key]
        }); });
        alert.buttons = [{
                text: 'Cancel',
                role: 'cancel',
                ...
                handler: function (selected) {
                    for (var _b = 0, _c = Object.keys(_this.options); _b < _c.length; _b++) {
                        var key = _c[_b];
                        _this.options[key] = selected.indexOf(key) > -1;
                    }
    ...
    Calculator.prototype.currency = function (amount) {
        return amount ? "$" + amount.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,') : '';
    };
    Calculator.prototype.render = function () {
        return (h(Host, null, this.data ? this.renderCalculator() : null));
    };
    Calculator.prototype.renderCalculator = function () {
        var _this = this;
        return (h("div", null, h("ion-card", null, h("ion-item", { class: this.errors[InvestmentGuideValueKey.amount] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Amount"), h("ion-input", { value: this.data.amount.toString(), onIonChange: this.handleAmountChange.bind(this) }), h("ion-button", { slot: "end", fill: "clear", size: "default", onClick: function () { return _this.configClick.emit(); } }, h("ion-icon", { name: "cog", slot: "icon-only" }))), this.renderError(InvestmentGuideValueKey.amount)), h("ion-card", null, h("ion-item", null, h("ion-icon", { name: "options", slot: "start" }), h("ion-label", null, "Parameters"), h("ion-button", { slot: "end", fill: "clear", size: "default", onClick: this.presentAlertCheckbox.bind(this) }, h("ion-icon", { name: "add", slot: "icon-only" }))), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.marginalTaxRate], ValueKey.marginalTaxRate, 1, 1, 50), this.renderError(ValueKey.marginalTaxRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.inflationRate], ValueKey.inflationRate, 0.25, 0.25, 20), this.renderError(ValueKey.inflationRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.investmentRate], ValueKey.investmentRate, 1, 0, 50), this.renderError(ValueKey.investmentRate), this.renderNumberStepper(InvestmentGuideValueLabel[ValueKey.investmentHorizon], ValueKey.investmentHorizon, 1, 1, 100), this.renderError(ValueKey.investmentHorizon), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.horizonMarginalTaxRate], ValueKey.horizonMarginalTaxRate, 1, 0, 50), this.renderError(ValueKey.horizonMarginalTaxRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.horizonEffectiveTaxRate], ValueKey.horizonEffectiveTaxRate, 1, 0, 50), this.renderError(ValueKey.horizonEffectiveTaxRate), this.renderPercentStepper(InvestmentGuideValueLabel[ValueKey.mortgageRate], ValueKey.mortgageRate, 0.25, 0.25, 50), this.renderError(ValueKey.mortgageRate), this.renderRRSPReinvestTaxReturnItem()), h("ion-card", null, this.renderMortgageItem(this.data.mortgage), this.renderTFSAItem(this.data.tfsa), this.renderRRSPItem(this.data.rrsp), this.renderNonRegisteredItem(this.data.nonRegistered)), h("ion-card", null, h("ion-card-content", null, h("div", { class: "chart-spinner", style: { 'display': this.showChart() == 'hidden' ? 'flex' : 'none' } }, h("ion-spinner", { name: "lines", color: "primary" })), h("canvas", { style: { 'visibility': this.showChart() }, ref: function (charts) { return _this.charts = charts; } })))));
    };
    Calculator.prototype.renderRRSPReinvestTaxReturnItem = function () {
        return this.options[InvestmentGuideValueKey.reinvestTaxReturn] || this.errors[InvestmentGuideValueKey.reinvestTaxReturn] ? [(h("ion-item", { class: this.errors[InvestmentGuideValueKey.amount] ? 'ion-invalid' : '' }, h("ion-checkbox", { slot: "start", checked: this.data.reinvestTaxReturn, onIonChange: this.handleReinvestTaxReturnChange.bind(this) }), h("ion-label", null, "RRSP Reinvest Tax Return"), h("info-button", { slot: "end" }, h("p", null, "Reinvest the tax return."))))] : null;
    };
    Calculator.prototype.renderFutureValue = function (data) {
    ...
    Calculator.prototype.renderMortgageItem = function (show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.mortgage } }), h("ion-label", null, AccountLabel.mortgage), this.renderFutureValue(this.mortgageData))) : null;
    };
    Calculator.prototype.renderTFSAItem = function (show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.tfsa } }), h("ion-label", null, AccountLabel.tfsa), this.renderFutureValue(this.tfsaData))) : null;
    };
    Calculator.prototype.renderRRSPItem = function (show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.rrsp } }), h("ion-label", null, AccountLabel.rrsp), this.renderFutureValue(this.rrspData))) : null;
    };
    Calculator.prototype.renderNonRegisteredItem = function (show) {
        return show ? (h("ion-item", null, h("ion-icon", { slot: "start", name: "analytics", style: { color: AccountColor.nonRegistered } }), h("ion-label", null, AccountLabel.nonRegistered), this.renderFutureValue(this.nonRegisteredData))) : null;
    };
    Calculator.prototype.renderPercentStepper = function (label, key, step, min, max) {
    ...
    Calculator.prototype.renderNumberStepper = function (label, key, step, min, max) {
    ...
    Calculator.prototype.renderError = function (key) {
        return this.errors[key] ? h("ion-item", { class: "error-item" }, h("ion-text", null, this.errors[key])) : null;
    };
    Calculator.prototype.showChart = function () {
        var show = !!((this.mortgageData && this.mortgageData.chartData) || (this.tfsaData && this.tfsaData.chartData) || (this.rrspData && this.rrspData.chartData) || (this.nonRegisteredData && this.nonRegisteredData.chartData));
        return show ? 'inherit' : 'hidden';
    };
    Object.defineProperty(Calculator, "watchers", {
        get: function () {
            return {
                "value": ["dataWatchHandler"]
            };
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Calculator, "style", {
        get: function () { return ".padding-horizontal{padding:0 10px}.chart-spinner{width:100%;height:100%;position:absolute;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;left:0;top:0}.ion-invalid{--border-color:var(--highlight-color-invalid)}.error-item,.ion-color-danger{color:var(--ion-color-danger)}.error-item{--min-height:20px;font-size:80%}"; },
        enumerable: true,
        configurable: true
    });
    return Calculator;
}());
var GeneralForm = /** @class */ (function () {
    function GeneralForm(hostRef) {
        registerInstance(this, hostRef);
        this.errors = {};
        this.valueChanged = createEvent(this, "valueChanged", 5);
    }
    GeneralForm.prototype.handlePercentValueChange = function (key, e) {
        var _b;
        var value = e.detail.value;
        if (this.isValid(value, key)) {
            this.valueChanged.emit(Object.assign(Object.assign({}, this.value), (_b = {}, _b[key] = +big(value).div(100), _b)));
        }
    };
    GeneralForm.prototype.handleNumberValueChange = function (key, e) {
        var _b;
        var value = e.detail.value;
        if (this.isValid(value, key)) {
            this.valueChanged.emit(Object.assign(Object.assign({}, this.value), (_b = {}, _b[key] = value, _b)));
        }
    };
    GeneralForm.prototype.isValid = function (value, key) {
        var _b, _c;
        var invalid = validate.single(value, getInvestmentGuideValueConstraints()[key]);
        if (invalid) {
            this.errors = Object.assign(Object.assign({}, this.errors), (_b = {}, _b[key] = invalid[0], _b));
    ...
    GeneralForm.prototype.percent = function (key) {
        var value = this.value[key];
        return value ? big(value).times(100).toString() : '';
    };
    GeneralForm.prototype.render = function () {
        return (h(Host, null, h("ion-card", null, h("ion-card-header", null, h("ion-card-title", null, "Details")), h("ion-item", { class: this.errors[GeneralFormValueKey.marginalTaxRate] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Current Marginal Tax Rate"), h("ion-input", { value: this.percent(GeneralFormValueKey.marginalTaxRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.marginalTaxRate) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "A marginal tax rate is the tax rate incurred on each additional dollar of income. ", h("br", null), "You can get the number from ", h("a", { href: "https://simpletax.ca/calculator", target: "_blank" }, "Simple Tax Calculator"), "."))), this.renderError(GeneralFormValueKey.marginalTaxRate), h("ion-item", { class: this.errors[GeneralFormValueKey.inflationRate] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Inflation Rate"), h("ion-input", { value: this.percent(GeneralFormValueKey.inflationRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.inflationRate) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "Inflation is the increase in the prices of goods and services over time. In July 2019 Canadian inflation rate was 2%"))), this.renderError(GeneralFormValueKey.inflationRate), h("ion-item", { class: this.errors[GeneralFormValueKey.investmentRate] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Yearly Investment Rate of Return"), h("ion-input", { value: this.percent(GeneralFormValueKey.investmentRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.investmentRate) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "A rate of return (RoR) is the net gain or loss on an investment over a year."))), this.renderError(GeneralFormValueKey.investmentRate), h("ion-item", { class: this.errors[GeneralFormValueKey.investmentHorizon] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Investment Horizon"), h("ion-input", { value: this.value.investmentHorizon.toString(), onIonChange: this.handleNumberValueChange.bind(this, GeneralFormValueKey.investmentHorizon) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "Investment horizon is the total length of time that you expect to hold a security or a portfolio."))), this.renderError(GeneralFormValueKey.investmentHorizon), h("ion-item", { class: this.errors[GeneralFormValueKey.horizonMarginalTaxRate] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Horizon Marginal Tax Rate"), h("ion-input", { value: this.percent(GeneralFormValueKey.horizonMarginalTaxRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.horizonMarginalTaxRate) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "A horizon marginal tax rate is the tax rate incurred on each additional dollar of income when you will withdraw a security or a portfolio. ", h("br", null), "You can get the number from ", h("a", { href: "https://simpletax.ca/calculator", target: "_blank" }, "Simple Tax Calculator"), "."))), this.renderError(GeneralFormValueKey.horizonMarginalTaxRate), h("ion-item", { class: this.errors[GeneralFormValueKey.horizonEffectiveTaxRate] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Horizon Actual Tax Rate"), h("ion-input", { value: this.percent(GeneralFormValueKey.horizonEffectiveTaxRate), onIonChange: this.handlePercentValueChange.bind(this, GeneralFormValueKey.horizonEffectiveTaxRate) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "A horizon marginal tax rate is the tax rate incurred on each additional dollar of income when you will withdraw a security or a portfolio. ", h("br", null), "You can get the number from ", h("a", { href: "https://simpletax.ca/calculator", target: "_blank" }, "Simple Tax Calculator"), "."))), this.renderError(GeneralFormValueKey.horizonEffectiveTaxRate))));
    };
    GeneralForm.prototype.renderError = function (key) {
        return this.errors[key] ? h("ion-item", { class: "error-item" }, h("ion-text", null, this.errors[key])) : null;
    };
    Object.defineProperty(GeneralForm, "style", {
        get: function () { return ".ion-invalid{--border-color:var(--highlight-color-invalid)}.error-item,.ion-color-danger{color:var(--ion-color-danger)}.error-item{--min-height:20px;font-size:80%}"; },
        enumerable: true,
        configurable: true
    });
    return GeneralForm;
}());
var InfoButton = /** @class */ (function () {
    function InfoButton(hostRef) {
        registerInstance(this, hostRef);
    }
    InfoButton.prototype.componentWillLoad = function () {
        this.message = this.host.innerHTML;
    };
    InfoButton.prototype.handleClick = function (event) {
    ...
    Object.defineProperty(InfoButton.prototype, "host", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(InfoButton, "style", {
...
var MortgageForm = /** @class */ (function () {
    function MortgageForm(hostRef) {
        registerInstance(this, hostRef);
        this.errors = {};
        this.valueChanged = createEvent(this, "valueChanged", 5);
    }
    MortgageForm.prototype.handlePercentValueChange = function (key, e) {
        var _b;
        var value = e.detail.value;
        if (this.isValid(value, key)) {
            this.valueChanged.emit(Object.assign(Object.assign({}, this.value), (_b = {}, _b[key] = +big(value).div(100), _b)));
    ...
    MortgageForm.prototype.handleNumberValueChange = function (key, e) {
        var _b;
        var value = e.detail.value;
        if (this.isValid(value, key)) {
            this.valueChanged.emit(Object.assign(Object.assign({}, this.value), (_b = {}, _b[key] = value, _b)));
    ...
    MortgageForm.prototype.isValid = function (value, key) {
        var _b, _c;
        var invalid = validate.single(value, getInvestmentGuideValueConstraints()[key]);
        if (invalid) {
            this.errors = Object.assign(Object.assign({}, this.errors), (_b = {}, _b[key] = invalid[0], _b));
    ...
    MortgageForm.prototype.percent = function (key) {
        var value = this.value[key];
        return value ? big(value).times(100).toString() : '';
    };
    MortgageForm.prototype.render = function () {
        return (h(Host, null, h("ion-card", null, h("ion-card-header", null, h("ion-card-title", null, "Mortgage Details")), h("ion-item", { class: this.errors[MortgageFormValueKey.mortgageBalance] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Balance"), h("ion-input", { value: this.value.mortgageBalance.toString(), onIonChange: this.handleNumberValueChange.bind(this, MortgageFormValueKey.mortgageBalance) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "A mortgage balance is the current amount owed by you."))), this.renderError(MortgageFormValueKey.mortgageBalance), h("ion-item", { class: this.errors[MortgageFormValueKey.mortgageRate] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Rate"), h("ion-input", { value: this.percent(MortgageFormValueKey.mortgageRate), onIonChange: this.handlePercentValueChange.bind(this, MortgageFormValueKey.mortgageRate) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "A mortgage rate is the rate of interest charged on your mortgage."))), this.renderError(MortgageFormValueKey.mortgageRate), h("ion-item", { class: this.errors[MortgageFormValueKey.mortgageAmortization] ? 'ion-invalid' : '' }, h("ion-label", { position: "floating" }, "Amortization"), h("ion-input", { value: this.value.mortgageAmortization.toString(), onIonChange: this.handleNumberValueChange.bind(this, MortgageFormValueKey.mortgageAmortization) }), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "The amortization period refers to the length of time, in years, that you chooses to pay off a mortgage."))), this.renderError(MortgageFormValueKey.mortgageAmortization))));
    };
    MortgageForm.prototype.renderError = function (key) {
        return this.errors[key] ? h("ion-item", { class: "error-item" }, h("ion-text", null, this.errors[key])) : null;
    };
    Object.defineProperty(MortgageForm, "style", {
        get: function () { return ".ion-invalid{--border-color:var(--highlight-color-invalid)}.error-item,.ion-color-danger{color:var(--ion-color-danger)}.error-item{--min-height:20px;font-size:80%}"; },
        enumerable: true,
        configurable: true
    });
...
var RRSPForm = /** @class */ (function () {
    function RRSPForm(hostRef) {
        registerInstance(this, hostRef);
        this.reinvestTaxReturnChange = createEvent(this, "reinvestTaxReturnChange", 5);
    }
    RRSPForm.prototype.handleChange = function (e) {
        this.reinvestTaxReturnChange.emit(e.detail.checked);
    };
    RRSPForm.prototype.render = function () {
        return (h(Host, null, h("ion-card", null, h("ion-card-header", null, h("ion-card-title", null, "RRSP Details")), h("ion-item", null, h("ion-checkbox", { slot: "start", checked: this.reinvestTaxReturn, onIonChange: this.handleChange.bind(this) }), h("ion-label", null, "Reinvest Tax Return"), h("budgific-ig-info-button", { slot: "end" }, h("p", null, "Reinvest the tax return."))))));
    };
    Object.defineProperty(RRSPForm, "style", {
        get: function () { return ""; },
        enumerable: true,
        configurable: true
    });
...
var StepperItem = /** @class */ (function () {
    function StepperItem(hostRef) {
        registerInstance(this, hostRef);
        this.value = 0;
        this.stateValue = '';
        this.invalid = false;
    ...
    StepperItem.prototype.watch = function () {
        this.stateValue = this.value.toString();
    };
    StepperItem.prototype.componentWillLoad = function () {
        this.stateValue = this.value.toString();
    };
    StepperItem.prototype.handleDecrease = function () {
        var nextValue = +big(this.stateValue).minus(this.step);
        if (this.min) {
    ...
    StepperItem.prototype.handleIncrease = function () {
        var nextValue = +big(this.stateValue).plus(this.step);
        if (this.max) {
    ...
    StepperItem.prototype.handleChange = function (e) {
        var value = e.detail.value;
        var invalid = validate.single(value, this.constraint);
        if (!invalid) {
            if (+value !== this.value) {
    ...
    StepperItem.prototype.render = function () {
        var _this = this;
        var itemClass = this.error ? 'ion-invalid' : '';
        return (h(Host, null, h("ion-item", { class: itemClass }, h("ion-label", { position: "floating" }, this.label), h("ion-input", { value: this.stateValue.toString(), onIonChange: function (e) { return _this.handleChange(e); }, required: true }), h("ion-button", { slot: "end", fill: "clear", size: "default", onClick: this.handleDecrease.bind(this) }, h("ion-icon", { name: "arrow-dropleft-circle", slot: "icon-only" })), h("ion-button", { class: "no-margin", slot: "end", fill: "clear", size: "default", onClick: this.handleIncrease.bind(this) }, h("ion-icon", { name: "arrow-dropright-circle", slot: "icon-only" }))), this.renderError(this.error)));
    };
    StepperItem.prototype.renderError = function (error) {
        return error ? h("ion-item", { class: "error-item" }, h("ion-text", null, error)) : null;
    };
    Object.defineProperty(StepperItem, "watchers", {
        get: function () {
            return {
                "value": ["watch"]
            };
    ...
    Object.defineProperty(StepperItem, "style", {
        get: function () { return ".no-margin{margin-left:0}"; },
        enumerable: true,
        configurable: true
    });
    return StepperItem;
...
var InvestmentGuide = /** @class */ (function () {
    function InvestmentGuide(hostRef) {
        registerInstance(this, hostRef);
        this.data = {
            amount: 1000,
    ...
    InvestmentGuide.prototype.componentWillLoad = function () {
        if (this.value) {
            var constrains = getInvestmentGuideValueConstraints(false);
            for (var _b = 0, _c = Object.keys(this.value); _b < _c.length; _b++) {
                var key = _c[_b];
    ...
    InvestmentGuide.prototype.invalidForm = function () {
        return !!validate(this.data, getInvestmentGuideValueConstraints());
    };
    InvestmentGuide.prototype.handleValueChange = function (e) {
        this.data = Object.assign(Object.assign({}, this.data), e.detail);
        this.valueChange.emit(this.data);
    };
    InvestmentGuide.prototype.handleCalculateClick = function () {
        this.mode = Mode.calculator;
    };
    InvestmentGuide.prototype.handleConfigClick = function () {
        this.mode = Mode.wizard;
    };
    InvestmentGuide.prototype.render = function () {
        return (h(Host, null, h("div", { class: "content" }, this.renderWizard(this.mode), this.renderCalculator(this.mode))));
    };
    InvestmentGuide.prototype.renderCalculator = function (mode) {
    ...
    InvestmentGuide.prototype.renderWizard = function (mode) {
        var _this = this;
        return mode === Mode.wizard ? (h("div", { class: "wizard" }, h("budgific-ig-accounts-form", { value: this.data, onValueChanged: this.handleValueChange.bind(this) }), h("budgific-ig-general-form", { value: this.data, onValueChanged: this.handleValueChange.bind(this) }), this.renderMortgageForm(this.data.mortgage), this.renderRRSPForm(this.data.rrsp), h("ion-button", { disabled: this.invalidForm(), onClick: function () { return _this.handleCalculateClick(); } }, "Calculate"))) : null;
    };
    InvestmentGuide.prototype.renderMortgageForm = function (show) {
        return show ? h("budgific-ig-mortgage-form", { value: this.data, onValueChanged: this.handleValueChange.bind(this) }) : null;
    };
    InvestmentGuide.prototype.renderRRSPForm = function (show) {
    ...
    Object.defineProperty(InvestmentGuide, "style", {
        get: function () { return ".content{text-align:center}.content>*{margin:auto;--ion-color-danger:#f04141}"; },
        enumerable: true,
        configurable: true
    });
...
var Alert = /** @class */ (function () {
    ...
    Alert.prototype.rbClick = function (selectedInput) {
        for (var _b = 0, _c = this.processedInputs; _b < _c.length; _b++) {
            var input = _c[_b];
    ...
    Alert.prototype.render = function () {
        var _b;
        var _c = this, overlayIndex = _c.overlayIndex, header = _c.header, subHeader = _c.subHeader;
        var mode = getIonMode$1(this);
...
var Backdrop = /** @class */ (function () {
    ...
    Backdrop.prototype.onMouseDown = function (ev) {
        if (this.lastClick < now$1(ev) - 2500) {
            this.emitTap(ev);
        }
    };
    ...
    Backdrop.prototype.render = function () {
        var _b;
        var mode = getIonMode$1(this);
        return (h(Host, { tabindex: "-1", class: (_b = {},
                _b[mode] = true,
                _b['backdrop-hide'] = !this.visible,
                _b['backdrop-no-tappable'] = !this.tappable,
                _b) }));
    };
...
var Card = /** @class */ (function () {
    ...
    Card.prototype.renderCard = function (mode) {
        ...
        var _b = this, href = _b.href, routerDirection = _b.routerDirection;
    ...
    Card.prototype.render = function () {
        var _b;
        var mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign((_b = {}, _b[mode] = true, _b), createColorClasses$1(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    };
...
var CardHeader = /** @class */ (function () {
    ...
    CardHeader.prototype.render = function () {
        var _b;
        var mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), (_b = { 'card-header-translucent': this.translucent }, _b[mode] = true, _b)) }, h("slot", null)));
    };
...
var CardTitle = /** @class */ (function () {
    ...
    CardTitle.prototype.render = function () {
        var _b;
        var mode = getIonMode$1(this);
        return (h(Host, { role: "heading", "aria-level": "2", class: Object.assign({}, createColorClasses$1(this.color), (_b = {}, _b[mode] = true, _b)) }, h("slot", null)));
    };
...
var Checkbox = /** @class */ (function () {
    ...
    Checkbox.prototype.render = function () {
        var _b;
        var _this = this;
        var _c = this, inputId = _c.inputId, indeterminate = _c.indeterminate, disabled = _c.disabled, checked = _c.checked, value = _c.value, color = _c.color, el = _c.el;
        ...
        return (h(Host, { onClick: this.onClick, role: "checkbox", "aria-disabled": disabled ? 'true' : null, "aria-checked": "" + checked, "aria-labelledby": labelId, class: Object.assign({}, createColorClasses$1(color), (_b = {}, _b[mode] = true, _b['in-item'] = hostContext('ion-item', el), _b['checkbox-checked'] = checked, _b['checkbox-disabled'] = disabled, _b['checkbox-indeterminate'] = indeterminate, _b['interactive'] = true, _b)) }, h("svg", { class: "checkbox-icon", viewBox: "0 0 24 24" }, path), h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: function (btnEl) { return _this.buttonEl = btnEl; } })));
    };
...
var Input = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { "aria-disabled": this.disabled ? 'true' : null, class: Object.assign({}, createColorClasses$1(this.color), (_b = {}, _b[mode] = true, _b['has-value'] = this.hasValue(), _b['has-focus'] = this.hasFocus, _b)) }, h("input", { class: "native-input", ref: function (input) { return _this.nativeInput = input; }, "aria-labelledby": labelId, disabled: this.disabled, accept: this.accept, autoCapitalize: this.autocapitalize, autoComplete: this.autocomplete, autoCorrect: this.autocorrect, autoFocus: this.autofocus, inputMode: this.inputmode, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, multiple: this.multiple, name: this.name, pattern: this.pattern, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellCheck: this.spellcheck, step: this.step, size: this.size, type: this.type, value: value, onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeydown }), (this.clearInput && !this.readonly && !this.disabled) && h("button", { type: "button", class: "input-clear-icon", tabindex: "-1", onTouchStart: this.clearTextInput, onMouseDown: this.clearTextInput })));
    };
...
var Label = /** @class */ (function () {
    ...
    Label.prototype.render = function () {
        ...
        var position = this.position;
        var mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), (_b = {}, _b[mode] = true, _b["label-" + position] = position !== undefined, _b["label-no-animate"] = (this.noAnimate), _b)) }));
    };
...
var Note = /** @class */ (function () {
    ...
    Note.prototype.render = function () {
        var _b;
        var mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), (_b = {}, _b[mode] = true, _b)) }, h("slot", null)));
    };
 ...
 */
var iosEnterAnimation$1 = function (baseEl, ev) {
    var originY = 'top';
    var originX = 'left';
 ...
 */
var iosLeaveAnimation$1 = function (baseEl) {
    var baseAnimation = createAnimation();
    var backdropAnimation = createAnimation();
    var wrapperAnimation = createAnimation();
    backdropAnimation
 ...
 */
var mdEnterAnimation$1 = function (baseEl, ev) {
 ...
 */
var mdLeaveAnimation$1 = function (baseEl) {
    var baseAnimation = createAnimation();
    var backdropAnimation = createAnimation();
    var wrapperAnimation = createAnimation();
    backdropAnimation
...
var Popover = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _b.usersElement = _c.sent();
                        return [4 /*yield*/, deepReady(this.usersElement)];
                    case 2:
                        _c.sent();
                        return [2 /*return*/, present(this, 'popoverEnter', iosEnterAnimation$1, mdEnterAnimation$1, this.event)];
                }
            });
        });
    };
    ...
    class_2.prototype.dismiss = function (data, role) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, dismiss(this, data, role, 'popoverLeave', iosLeaveAnimation$1, mdLeaveAnimation$1, this.event)];
                    case 1:
                        shouldDismiss = _b.sent();
...
var RippleEffect = /** @class */ (function () {
     ...
     */
    class_3.prototype.addRipple = function (x, y) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_b) {
    ...
    Object.defineProperty(class_3.prototype, "unbounded", {
        get: function () {
...
var SkeletonText = /** @class */ (function () {
    ...
    SkeletonText.prototype.render = function () {
        ...
        var mode = getIonMode$1(this);
        return (h(Host, Object.assign({ class: (_b = {},
                _b[mode] = true,
                _b['skeleton-text-animated'] = animated,
                _b['in-media'] = inMedia,
                _b) }, this.calculateWidth()), h("span", null, "\u00A0")));
    };
...
var Spinner = /** @class */ (function () {
    ...
    Spinner.prototype.render = function () {
        ...
        return (h(Host, { class: Object.assign({}, createColorClasses$1(self.color), (_b = {}, _b[mode] = true, _b["spinner-" + spinnerName] = true, _b['spinner-paused'] = !!self.paused || config.getBoolean('_testing'), _b)), role: "progressbar", style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} }, svgs));
    };
...
export { AccountsForm as budgific_ig_accounts_form, Calculator as budgific_ig_calculator, GeneralForm as budgific_ig_general_form, InfoButton as budgific_ig_info_button, MortgageForm as budgific_ig_mortgage_form, RRSPForm as budgific_ig_rrsp_form, StepperItem as budgific_ig_stepper_item, InvestmentGuide as budgific_investment_guide, Alert as ion_alert, Backdrop as ion_backdrop, Button as ion_button, Card as ion_card, CardContent as ion_card_content, CardHeader as ion_card_header, CardTitle as ion_card_title, Checkbox as ion_checkbox, Icon as ion_icon, Input as ion_input, Item as ion_item, Label as ion_label, Note as ion_note, Popover as ion_popover, RippleEffect as ion_ripple_effect, SkeletonText as ion_skeleton_text, Spinner as ion_spinner, Text as ion_text };
